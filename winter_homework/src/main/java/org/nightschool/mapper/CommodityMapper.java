...
public interface CommodityMapper {
    ...
    @Results(value = {
            ...
            @Result(property = "publishDate", column = "publish_date", javaType = Date.class, jdbcType = JdbcType.TIMESTAMP)})
    ...
    public void updateSaleAndStockById(int num,int id);

    @Update("update commodity set com_desc=#{comDesc},old_price=#{oldPrice},new_price=#{newPrice},stock=#{stock} where id=#{id}")
